      ...
      <div className="container relative" ref={parallaxRef}>
        <div className="relative z-1 max-w-[62rem] mx-auto text-center mb-[3.875rem] md:mb-20 lg:mb-[6.25rem]">
          <h1 className="h1 mb-6">
            Explore the Possibilities of Automated QA testing with {` `}
          ...
          <p className="body-1 max-w-3xl mx-auto mb-6 text-n-2 lg:mb-8">
            Unleash the power of Agents. Upgrade your productivity
            with Scout, the automated QA testing agent.
          </p>
          <Button href="https://airtable.com/appxgh06clCE26z1H/shrySLs15u1uBwOQT" white>
            Join Waitlist
          </Button>
        </div>
